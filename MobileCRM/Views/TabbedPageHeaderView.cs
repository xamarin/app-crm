...
{
    public class TabbedPageHeaderView : ContentView
    {
        public Image BackButtonImage { get; private set; }

        public Label TitleLabel { get; private set; }

        public Label DoneActionLabel { get; private set; }

        public TabbedPageHeaderView(string headerTitle, string doneActionTitle)
        {
            ...
            relativeLayout.Children.Add(
                ...
                widthConstraint: Constraint.RelativeToParent(parent => parent.Height - (parent.Height * paddingPercent)),
            ...
            Device.OnPlatform(iOS: () => outerContentView.Padding = new Thickness(0, 20, 0, 0));
            #endregion
