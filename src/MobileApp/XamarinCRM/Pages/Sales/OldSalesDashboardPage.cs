...
{
    public class OldSalesDashboardPage : ContentPage
    {
        ...
        public OldSalesDashboardPage()
        {
            ...
            OldSalesDashboardChartView salesChartView = new OldSalesDashboardChartView() { BindingContext = _SalesDashboardChartViewModel };
            #endregion

            #region leads view
            _SalesDashboardLeadsViewModel = new SalesDashboardLeadsViewModel(new Command(PushTabbedLeadPageAction));
            OldLeadsView leadsView = new OldLeadsView() { BindingContext = _SalesDashboardLeadsViewModel };
            #endregion
