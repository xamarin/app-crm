...
[assembly: ExportRenderer(typeof(XamarinCRM.CustomControls.BarChart), typeof(BarChartRenderer))]

namespace XamarinCRMAndroid.Renderers
{
    public class BarChartRenderer : ViewRenderer<XamarinCRM.CustomControls.BarChart, PlotView>
    {
        static OxyColor FILLCOLOR = OxyColor.FromRgb(180, 188, 188);

        protected override void OnElementChanged(ElementChangedEventArgs<XamarinCRM.CustomControls.BarChart> e)
        {
